...
export default function NavigationBar() {
  return (
    <header className="rounded-xl px-4 sticky top-0 flex justify-between bg-background z-20 opacity-85 pb-3 ">
              ...
              <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                <li className="row-span-3">
                  <NavigationMenuLink asChild>
                    <a
                      className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-halcyon-dark-background-3/50 to-halcyon-dark-background-1 p-6 no-underline outline-none focus:shadow-md"
                      href="/"
                    >
